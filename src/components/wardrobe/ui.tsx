...
export function PageShell({ title, children }: { title: string; children: ReactNode }) {
  return <main className="closet-index-page wc-page"><Link href="/" className="closet-index-page__home" aria-label="Back to home"><BackIcon/></Link><header className="closet-index-page__header"><h1>{title}</h1></header>{children}</main>;
}
